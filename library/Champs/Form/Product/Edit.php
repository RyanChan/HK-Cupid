...
class Champs_Form_Product_Edit extends Champs_FormProcessor {
    ...
    public function __construct($product) {
        ...
        if ($this->product) {
            ...
            $this->product_status = $this->product->getProfile('status');
            $this->product_payment = $this->product->getProfile('payment');
            $this->product_delivery = $this->product->getProfile('delivery');
            $this->product_searchable = $this->product->getProfile('searchable');
            $this->product_quantity = $this->product->quantity;
            $this->product_description = $this->product->getProfile('description');
